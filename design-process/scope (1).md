...
> *"Even a coin designed to be worth exactly one dollar produces a ₹44,400 disagreement on a single invoice. If it happens with the stable one, it happens with all of them."*
...
>
> One payment, one country, one question. Stablecoins only — and we chose the *hardest* case for our own argument, because if a coin designed to be worth exactly one dollar produces a ₹44,400 disagreement, the volatile ones are worse.
>
