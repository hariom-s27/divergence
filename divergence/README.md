...
run the pipeline end to end, and all 15 dated design decisions merged into
...
| `DECISION-D42.md` … `DECISION-D56.md` | Fifteen dated documents, each recording one real design decision or bug — merged into `START-HERE.md`, kept individually for full detail |
