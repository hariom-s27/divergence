...
run the pipeline end to end, and all 18 dated design decisions merged into
...
| `DECISION-D41.md` … `DECISION-D58.md` | Eighteen dated documents, each recording one real design decision or bug — merged into `START-HERE.md`, kept individually for full detail |
