...
tax_year_applicable: "FY 2026-27 onwards cite Rule 57. FY 2025-26 and earlier cite Rule 11UA."
tier: A
citable: true
retrieved: 2026-08-06
source_url: "https://www.incometaxindia.gov.in/w/rule-11ua"
source_type: official_superseded
completeness: full
extract_scope: "Complete rule, sub-rules (1) to (4)"
text_sha256: "ca8a373b7a0980a72b4a7adb15896b1c3ae2db74c695b644087b5143b51add41"
known_limitation: "1962 text. The renumbering to Rule 57 comes from a mapping table, not the 2026 bare Rules. VERIFY against the ICAI tabular mapping before this becomes load-bearing."
---

# Rule 11UA — Determination of fair market value
## COMPLETE. UNTRUNCATED. DO NOT EDIT.
<!-- VERBATIM-START -->
...
**Search the text above for "virtual digital asset". It is not there. Search for "crypto". Not there. "token". Not there.**

**That absence is now demonstrable rather than asserted** — because the rule is here in full, and anyone can check.

## What the rule actually covers — a closed list of three

| Sub-rule (1) | Category |
|---|---|
| (a) | Jewellery |
| (b) | Archaeological collections, drawings, paintings, sculptures, works of art |
| (c) | Shares and securities |

Sub-rules (2), (3) and (4) deal **exclusively** with unquoted equity shares and compulsorily convertible preference shares for section 56(2)(viib) — the angel-tax provision. **Nothing broadens the scope.**

## ⭐⭐ THE GAP IS A CLOSED CHAIN — VERIFIED 6 AUGUST

This is no longer *"there is no rule."* It is something much sharper: **the statute expressly requires a prescribed method, and the prescribing rule was never extended to cover the asset.**

**The chain, link by link:**

| # | Link | Status |
|---|---|---|
| 1 | **s.2(47A)** defines "virtual digital asset" — inserted by Finance Act 2022 | ✅ verified |
| 2 | **s.56(2)(x) Explanation amended** so that *"the expression 'property' shall have the meaning assigned to it in Explanation to clause (vii) **and shall include virtual digital asset**"* — effective 1 April 2023 | ✅ verified |
| 3 | **That same Explanation defines fair market value as** *"the value determined using the method(s) prescribed"* | ✅ verified |
| 4 | **Rule 11UA is the prescribing rule** — and its full text is above | ✅ in this file |
| 5 | **"Virtual digital asset" appears in that text ZERO times.** Nor "crypto", "token", "digital asset" or "currency" | ✅ **machine-checked** |

### Therefore

> **Parliament brought virtual digital assets into section 56, and section 56 says their value is whatever the prescribed method says. No method was ever prescribed. The Act asks a question of itself and does not answer.**

**That is a self-referential gap, and it is provable in five steps a judge can follow.** It is not an omission from a list — it is a statute pointing at a rule that does not reach the case.

### Professional corroboration, dated June 2026
A law firm, writing this year:

> *"According to the Explanation to section 56(2)(x), fair market value of the property means the value determined using the method(s) prescribed by the Competent Authority. **However, the methods of valuation of VDA are yet to be prescribed.**"*

They list among the open practical challenges: *"What is the valuation mechanism to be adopted for computing the fair value of consideration on the transfer of VDA?"*

**Four years after VDAs entered section 56, practitioners are still asking.**

---

## AND THE SECOND SCOPING POINT — still worth making

Sub-rule (1) opens: *"For the purposes of **section 56** of the Act, the fair market value of **a property, other than immovable property**, shall be determined in the following manner."*

Two things follow, and the second is sharper than anything we had before.

**Rule 11UA is scoped to section 56.** Our freelancer's receipt is **not** a section 56 receipt — she received USDC as *consideration for services*, which is business income under section 28.

**So the gap is doubled, not halved:**

| Situation | Position |
|---|---|
| VDA received as a **gift** (s.56) | Statute demands a prescribed method. **None prescribed.** |
| VDA received as **payment for services** (s.28) | **No FMV rule is even scoped to this head.** Not one that omits VDAs — none at all |

**Our case sits in the second row.** The freelancer is worse off than the person who was gifted crypto: at least the gift recipient has a statute pointing at an empty rule. She has nothing pointing anywhere.

## And note the drafting pattern

**Rule 11UAB** borrows Rule 11UA's method by reference, for inventory converted into a capital asset. The drafter extends the method where he intends it to apply.

**Nobody extended it to virtual digital assets.**

---

## Provenance
- Text as at the 1962 Rules, retrieved 6 August 2026 from incometaxindia.gov.in
- Sub-clause (1)(c)(b) substituted by the Income-tax (Twentieth Amendment) Rules, 2017, w.e.f. 1-4-2018
- Sub-rule (2) as amended by Notification 81/2023
- **Renumbering to Rule 57 under the Income-tax Rules, 2026 — from a mapping table, NOT YET VERIFIED against the bare Rules**
