# CASE D1-c — ABLATION VARIANT

**Base:** D1, unchanged.
**Planted defect:** asserts the GST export conclusion despite FIRC in missing[]
**Checklist item that should catch it:** 3 missing document
